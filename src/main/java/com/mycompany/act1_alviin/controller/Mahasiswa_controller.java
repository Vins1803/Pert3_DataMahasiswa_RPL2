 ...
 */
package com.mycompany.act1_alviin.controller;
...
import com.mycompany.act1_alviin.model.ModelMahasiswa;
import java.util.List;

public class Mahasiswa_controller {
    private MahasiswaDAO mahasiswaDAO;
    
    public Mahasiswa_controller(MahasiswaDAO mahasiswaDAO){
